...
class GtpConnection():
    ...
    def __init__(self, go_engine, debug_mode = False):
        ...
        self.commands = {
            ...
            "print_timelimit": self.print_timelimit_cmd
        ...
        self.argmap = {
            ...
            "timelimit":(1, 'Usage: timelimit {1-100}')
    ...
    def print_timelimit_cmd(self,args):
        print(self.board.print_timelimit())

    def timelimit_cmd(self,args):
        self.board.set_time_limit(args[0])
        print("timelimit set")
        pass
